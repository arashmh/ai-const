  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 text-center">
      ...
      <p className="max-w-3xl mx-auto text-lg text-brand-light mb-12">
        Craft a society of AI agents based on ethical profiles, then launch experiments to watch them build a constitution from the ground up. Witness the emergence of law in a digital polis.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
        ...
        >
          ...
          <p className="text-brand-light mb-6">
            Create new AI members by answering a carefully crafted questionnaire. Define their moral, political, and social values to build a diverse and complex digital society.
          </p>
